  ...
  return (
    <div className={css.home}>
        <div className={css.photo}>
            <img src="https://cdn.pixabay.com/photo/2023/07/25/18/42/vector-graphic-8149677_1280.jpg" alt="My_Photo_In_Car" className={css.imageHome}/>
        </div>
        <div>
            ...
            <div className={css.divButtons}>
              ...
              <NavLink to="/contact" className={css.linkButton}><button className={css.Hbutton}>Contact</button></NavLink>
            </div>
        </div>
    </div>
  )
